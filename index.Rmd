...
```
pixi add matplotlib spyder gdal shapely geopandas>=1.0 owslib osmnx contextily
```
...
gdf_edges.to_file('./output/OSMnetwork_Wageningen.shp', driver='ESRI Shapefile')
...
### PROBLEMS WITH BASEMAP: ACCESS BLOCKED 403r
import folium

# Load Basemap
basemap = folium.TileLayer(tiles="https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png",
                            attr='voyager',
                            referrer_policy="voyager")

# Initialize the map
campusMap = folium.Map([51.98527485, 5.66370505205543], tiles = basemap, zoom_start=17)
